...
void updateDeviceTelemetry(String deviceId, String ip, int timeRemaining, int state, int battery = -1, bool charging = false, unsigned long long ts = 0, bool isApp = false);
