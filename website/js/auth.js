...
/**
 * Opens modal to register Coin Slot Boxes to account
 */
    ...
    const modalHtml = `
        <div id="coinSlotBoxModal" class="fixed inset-0 z-[999] flex items-center justify-center bg-slate-950/85 backdrop-blur-md p-4 animate-fade-in-up">
            <div class="glass-card bg-slate-900 border border-emerald-500/40 rounded-3xl w-full max-w-md p-6 sm:p-8 shadow-2xl relative text-slate-100 overflow-hidden">
                ...
                <div class="space-y-4">
                    <div>
                        <label class="block text-xs font-bold text-slate-400 uppercase tracking-wider mb-2">ESP32 MAC Address or Box Serial Number</label>
                        ...
                        <p class="text-[11px] text-slate-500 mt-1.5">Enter the MAC address or serial number printed on your PisoPhone Box label.</p>
                    </div>
                    ...
                    <div class="flex gap-3 pt-2">
                        ...
                        <button id="modalBoxVerifyBtn" type="button" class="flex-1 bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-400 hover:to-teal-400 text-slate-950 font-bold py-3 rounded-xl transition text-sm flex items-center justify-center gap-2 shadow-lg shadow-emerald-500/20">
